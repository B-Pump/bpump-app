    ...
    return <>
        <View>
            ...
            <View style={styles.searchContainer}>
                ...
                <Pressable 
                    style={({ pressed }) => [{opacity: pressed ? 0.5 : 1, backgroundColor: useTheme().colors.icon}, styles.searchBtn]}
                    onPress={handleClick}
                >
                    <Image
                        source={icons.search}
                        resizeMode="contain"
                        style={[styles.searchBtnImage, { tintColor: useTheme().colors.background }]}
                    />
                </Pressable>
            </View>
            <View style={styles.tabsContainer}>
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <Pressable
                            style={({ pressed }) => [{opacity: pressed ? 0.5 : 1}, styles.tab]}
                            onPress={() => {
